# 안녕하세요 👋, 게임 시스템기획자를 희망하는 임현수 입니다!

게임을 좋아하고, 대화하는것을 좋아하는 게임 시스템기획자 임현수입니다.

---

## 👨‍💻 About Me:
학점은행제를 통해 컴퓨터공학을 전공중이고 <br> 폴리텍대학 하이테크과정 인공지능소프트웨어 학과에서 웹 프로그래밍을 배웠습니다.
<!--
...
- **Backend**:
  - ![Spring Boot](https://img.shields.io/badge/-Spring%20Boot-6DB33F?style=flat&logo=spring-boot&logoColor=white) ![JSP](https://img.shields.io/badge/-JSP-323330?style=flat&logo=java&logoColor=white) ![Flask](https://img.shields.io/badge/Flask-000000?style=flat&logoColor=white)
